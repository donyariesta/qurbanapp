...
export default function Authenticated({ user, header, children }: PropsWithChildren<{ user: User; header?: ReactNode }>) {
    ...
    const navItems: NavItem[] = [
        ...
        ...(can('procurements.index') ? [{ label: 'Pembelanjaan', routeName: 'procurements.index', active: route().current('procurements.*'), faicon: 'fa-cart-shopping' }] : []),
        ...(can('transactions.index') ? [{ label: 'Transaksi', routeName: 'transactions.index', active: route().current('transactions.*'), faicon: 'fa-right-left' }] : []),
